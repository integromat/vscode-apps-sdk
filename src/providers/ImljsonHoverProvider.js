    ...
    provideHover(document, position) {
        ...
        if (range && range.isSingleLine) {
            ...
            if (['name', 'type', 'label', 'help', 'default', 'advanced', 'required'].includes(key)) {
                help = help.concat(`\r\n- For more information see the [docs](https://docs.integromat.com/apps/parameters#${key}).`)
            }
        ...
        if (range && range.isSingleLine) {
            ...
            return help ? new vscode.Hover(new vscode.MarkdownString(`## ${type}\r\n___\r\n${help}\r\n- For more information see the [docs](https://docs.integromat.com/apps/parameters/${customLink || type}).`)) : undefined
        }
    }
