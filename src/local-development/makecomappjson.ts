...
export const COMPONENTS_WITH_AUTOGENERATED_ID = ['connection', 'webhook'];
...
async function _generateComponentLocalId(
	 ...
	 */
	if (COMPONENTS_WITH_AUTOGENERATED_ID.includes(componentType) && componentLocalIdPrefix !== componentType) {
