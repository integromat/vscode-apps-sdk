...
import { addComponentIdMapping, COMPONENTS_WITH_AUTOGENERATED_ID } from './makecomappjson';
...
export const COMPONENTS_CAN_BE_NON_OWNED = ['connection'];
					...
					case 'cloneAsNew':
						{
							...
							const newComponent = await createLocalEmptyComponent(
								...
								COMPONENTS_CAN_BE_NON_OWNED.includes(remoteOnlyComponent.componentType) &&
									remoteOnlyComponent.componentMetadata.isOwnedByAnotherApp
									? ''
									: remoteOnlyComponent.componentName,
