...
- Correct handling components with autogenerated IDs in case of multiple origins. The "alternative ID" must be implemented somehow, becase the component has different ID on each origin and there is no logic relation between these IDs.
